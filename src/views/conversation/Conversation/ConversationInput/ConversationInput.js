	...
	return (
		messages.editMessage.mode ?
			<form className={styles.wrapper}
						onSubmit={sendEditMessageHandler}
			>
				<div className={styles.editMode}>
					...
					<div className={styles.message}
							 dangerouslySetInnerHTML={{__html: messages.editMessage.message.text}}
					></div>
				</div>
				<MessageEditor buttonRef={buttonRef}
											 value={conversation.messageInput}
				/>
			...
			: messages.replyMessage.mode ?
				<form className={styles.wrapper}
							onSubmit={sendReplyMessageHandler}
				>
					<div className={styles.editMode}>
						<div className={styles.header}>
							<RiReplyLine/>
						...
						<div className={styles.message}
								 dangerouslySetInnerHTML={{__html: messages.replyMessage.message.text}}>
